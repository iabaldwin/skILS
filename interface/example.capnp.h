...
CAPNP_DECLARE_SCHEMA(f86b322f303c7e41);
CAPNP_DECLARE_SCHEMA(cf2e0b8d63bdf53d);
CAPNP_DECLARE_SCHEMA(b8269ea8e5a28be0);
enum class Type_b8269ea8e5a28be0: uint16_t {
  MOBILE,
  HOME,
  WORK,
};
CAPNP_DECLARE_ENUM(Type, b8269ea8e5a28be0);
CAPNP_DECLARE_SCHEMA(a9c05af5178b9fbf);
...
struct Person {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(f86b322f303c7e41, 0, 4)
    #if !CAPNP_LITE
...
struct Person::PhoneNumber {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::Type_b8269ea8e5a28be0 Type;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(cf2e0b8d63bdf53d, 1, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct Date {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(a9c05af5178b9fbf, 1, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
